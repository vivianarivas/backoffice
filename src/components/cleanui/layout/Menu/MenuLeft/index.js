      ...
      >
            <div className={style.logoContainer}>
              <div className={style.logo}>
                {/*<img src="resources/images/logoBmros.png" className={style.logoimage} alt={logo}/>*/}
                {isMenuCollapsed ? (
                <img
                  src="resources/images/minlogoBmros.png"
                  className={style.minlogoimage}
                  alt="Sucursal Virtual"
                />
              ) : (
                <img
                  src="resources/images/logoBmros.png"
